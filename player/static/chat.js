...
chatSocket.onmessage = function(e) {
    ...
    div.className = 'row';
    div.innerHTML = "<div class='message" + item_class + "' data-sender='" + data.id + "'><time class='message__time'>" + data.time + var_ban + "</time><figure class='message__author-pic'><a href='/profile/" + data.id + "' target='_blank'><img src=" + data.image + " width='50px' height='50px'></figure><div class='message__text'></a><p>" + data.message + "</p></div></div>";
