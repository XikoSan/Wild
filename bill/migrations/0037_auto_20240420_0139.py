...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bill', '0036_transferregion'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='transferregion',
            options={'verbose_name': 'Передача региона', 'verbose_name_plural': 'Передачи регионов'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='sender', to='state.state', verbose_name='Отдаёт')),
                ...
                ('votes_con', models.ManyToManyField(blank=True, related_name='transferaccept_votes_con', to='player.Player', verbose_name='Голоса "против"')),
                ('votes_pro', models.ManyToManyField(blank=True, related_name='transferaccept_votes_pro', to='player.Player', verbose_name='Голоса "за"')),
            ],
            options={
