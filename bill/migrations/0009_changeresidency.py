    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('residency', models.CharField(choices=[('free', 'Свободная'), ('issue', 'Выдаётся министром')], default='free', max_length=5)),
                ...
                ('votes_con', models.ManyToManyField(blank=True, related_name='changeresidency_votes_con', to='player.Player', verbose_name='Голоса "против"')),
                ('votes_pro', models.ManyToManyField(blank=True, related_name='changeresidency_votes_pro', to='player.Player', verbose_name='Голоса "за"')),
            ],
            options={
