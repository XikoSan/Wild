    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('war_type', models.CharField(blank=True, choices=[('GroundWar', 'Наземная война')], default=None, max_length=20, null=True, verbose_name='Тип войны')),
